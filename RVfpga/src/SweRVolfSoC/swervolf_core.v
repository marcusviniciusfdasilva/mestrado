...
`endif
  ...
  //i2c
   ...
   i2c_top temp_sensor
     (// Wishbone slave interface
      .clk_i  (clk),
      .rst_i  (wb_rst),
      .adr_i  (wb_m2s_i2c_adr),
      .dat_i  (wb_m2s_i2c_dat[31:0]),
      .we_i   (wb_m2s_i2c_we),
      .cyc_i  (wb_m2s_i2c_cyc),
      .stb_i  (wb_m2s_i2c_stb),
      .wb_sel (wb_m2s_i2c_sel),
      .dat_o  (wb_s2m_i2c_dat),
  ...
  //chacha
   ...
   chacha_top chacha20
     (// Wishbone slave interface
      .clk_i  (clk),
      .rst_i  (wb_rst),
      .adr_i  (wb_m2s_chacha_adr),
      .dat_i  (wb_m2s_chacha_dat[31:0]),
      .we_i   (wb_m2s_chacha_we),
      .cyc_i  (wb_m2s_chacha_cyc),
      .stb_i  (wb_m2s_chacha_stb),
      .wb_sel (wb_m2s_chacha_sel),
      .dat_o  (wb_s2m_chacha_dat),
      .ack_o  (wb_s2m_chacha_ack));

    assign wb_s2m_chacha_err =1'b0;
    assign wb_s2m_chacha_rty =1'b0;
  ...
  //POLY1305
   ...
   poly1305_top poly
     (// Wishbone slave interface
      .clk_i  (clk),
      .rst_i  (wb_rst),
      .adr_i  (wb_m2s_poly1305_adr),
      .dat_i  (wb_m2s_poly1305_dat[31:0]),
      .we_i   (wb_m2s_poly1305_we),
      .cyc_i  (wb_m2s_poly1305_cyc),
      .stb_i  (wb_m2s_poly1305_stb),
      .wb_sel (wb_m2s_poly1305_sel),
      .dat_o  (wb_s2m_poly1305_dat),
      .ack_o  (wb_s2m_poly1305_ack)
      );

    assign wb_s2m_poly1305_err =1'b0;
    assign wb_s2m_poly1305_rty =1'b0;
  ...
  //ADC
   ...
   xadc_top adc1
      ...
      .wb_clk_i     (clk), 
      .wb_rst_i     (wb_rst), 
      .wb_cyc_i     (wb_m2s_adc_cyc), 
      .wb_adr_i     (wb_m2s_adc_adr), 
      .wb_dat_i     (wb_m2s_adc_dat), 
      .wb_sel_i     (wb_m2s_adc_sel),
      .wb_we_i      (wb_m2s_adc_we), 
      .wb_stb_i     (wb_m2s_adc_stb), 
      .wb_dat_o     (wb_s2m_adc_dat),
      .wb_ack_o     (wb_s2m_adc_ack), 
      .wb_err_o     (wb_s2m_adc_err),
      //.wb_inta_o    (adc_irq),
      //ADC interface
      .vauxn3 (vauxn3),
      .vauxp3 (vauxp3),
